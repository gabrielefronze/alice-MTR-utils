...
Double_t AliRPCData::GetMeanSomething(UInt_t runNumber, Bool_t normalizeToArea,Double_t (AliRPCRunStatistics::*funky)() const)const{
    Int_t count=0;
    Double_t cumulus=0.;
    for(Int_t iPlane=0;iPlane<fNPlanes;iPlane++){
        for(Int_t iSide=0;iSide<fNSides;iSide++){
